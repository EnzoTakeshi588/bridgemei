...
const styles = `
  ...
  *, *::before, *::after { margin: 0; padding: 0; box-sizing: border-box; }
  ...
  :root {
    ...
    --text: #f8f8ff;
    --text2: rgba(248,248,255,0.4);
    --text3: rgba(248,248,255,0.2);
    --accent: #6366f1;
    --accent-hover: #5254cc;
  ...
  .sidebar {
    ...
    background: #0d0d15; border-right: 1px solid var(--border);
  ...
  .nav-item {
    ...
    color: var(--text2); font-size: 13.5px; margin-bottom: 2px;
  ...
  .main { margin-left: 240px; padding: 36px 40px; min-height: 100vh; animation: fadeIn 0.5s ease; }
...
export default function Home({ onNavegar }) {
  ...
  const handleIa = () => {
    ...
    if (q.includes("das")) resp = "O DAS vence todo dia 20 do mês seguinte. Você pode pagar pelo app do banco ou no site da Receita Federal.";
    else if (q.includes("dasn") || q.includes("declara")) resp = "A DASN-SIMEI é a declaração anual do MEI. O prazo é até 31 de maio de cada ano.";
    else if (q.includes("nota") || q.includes("nf")) resp = "O MEI pode emitir NFS-e pelo sistema da prefeitura e nota de produto pela SEFAZ estadual.";
    else if (q.includes("limite") || q.includes("faturamento")) resp = `Seu faturamento está em ${pct}% do limite anual de R$ 81.000. Restam R$ 12.600 para o ano.`;
    setIaResp(resp);
    setIaInput("");
  };
        ...
        <aside className="sidebar">
          ...
          <div className="sidebar-footer">
            <div className="user-info">
              ...
              <div>
                <div className="user-name">Tassi</div>
                <div className="user-role">MEI · Autônoma</div>
              </div>
            </div>
          </div>
        </aside>
