...
// ✅ CORRIGIDO: nome alterado de Home → MEI e navegação corrigida
export default function MEI({ onNavegar }) {
  ...
  const [activeNav, setActiveNav] = useState("mei");

  // ✅ CORRIGIDO: removido o "if (id !== 'home')" — agora navega para qualquer tela, inclusive Início
  const navegar = (id) => {
    setActiveNav(id);
    onNavegar(id);
  };
